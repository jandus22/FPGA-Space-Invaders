...
/* Module Version: 5.4 */
/* D:\Programs\Diamond\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_75mhz -lang verilog -synth synplify -arch xo2c00 -type pll -fin 50 -fclkop 75 -fclkop_tol 0.0 -fclkos 75 -fclkos_tol 0.0 -fclkos2 75 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 180 -phase_cntl STATIC -fb_mode 1 -e  */
/* Tue Nov 10 14:02:16 2015 */


`timescale 1 ns / 1 ps
module pll_75mhz (CLKI, CLKOP, CLKOS, CLKOS2)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll_75mhz dont_touch true 
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
